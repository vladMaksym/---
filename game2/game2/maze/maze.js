...
(function() {
    ...
    var PLAYER_COLOUR = "#A69911"; //чевоний
    var PLAYER_TRIM_COLOUR = "#755E02"; //темно чевоний
    
    var SOLUTION_FILL_COLOUR = "#FFCC00";//жовтий
    var SOLUTION_STROKE_COLOUR = "#755E02";//туьно жовтий
    var RANDOM_FILL_COLOUR = "#40FA39"; //зелений
    var RANDOM_STROKE_COLOUR = "#0A540D";//тз
    var END_FILL_COLOUR = "#E739FA";//фіол
    var END_STROKE_COLOUR = "#A028AD";
    
    var MESSAGE_FILL_COLOUR = "#90EBF0";//бір
    ...
    function drawMenu() {
        ...
        wrapText("Ваша мета - пройти лабіринт до фіолетової точки до того, " +
                 "як закінчиться час. Вам потрібно зібрати жовті та зелені " +
                 "як ви закінчите гру, а кожна зелена пляма дає " +
                 "вам ще 5 секунд на годиннику. Удачі!",
    ...
    function drawWinMessage() {
        ...
        menuContext.fillText("Congratulations!",
                         0.5 * menuCanvas.width, 0.5 * menuCanvas.height);
        menuContext.font = "40px Arial";
        menuContext.fillText("Ти фінішував із запасом у " + timeLeft + " секундами в запасі.",
                             0.5 * menuCanvas.width, 0.5 * menuCanvas.height + 75);
    
        if (touchCapable) {
            menuContext.fillText("Торкніться екрана, щоб продовжити відтворення.",
                                 0.5 * menuCanvas.width,
                                 0.5 * menuCanvas.height + 125);
        } else {
            menuContext.fillText("Натисніть «Enter», щоб продовжити відтворення.",
                                 0.5 * menuCanvas.width,
                                 0.5 * menuCanvas.height + 125);
        }
    ...
    function drawLostMessage() {
        ...
        menuContext.font = "60px Arial";
        menuContext.fillStyle = DANGER_STROKE_COLOUR;
        menuContext.fillText("Час вийшов!",
                             0.5 * menuCanvas.width,
